...
ln -sf /secrets/ssl/its-metrics.openshift.dsc.umich.edu.cert /etc/ssl/certs/its-metrics.openshift.dsc.umich.edu.cert
ln -sf /secrets/ssl/its-metrics.openshift.dsc.umich.edu.key /etc/ssl/private/its-metrics.openshift.dsc.umich.edu.key
